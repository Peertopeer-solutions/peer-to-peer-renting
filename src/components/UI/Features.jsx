					...
					<div className='relative '>
						<dt className=' md:text-xl flex flex-col items-center justify-center itemtext-base font-semibold leading-7 text-gray-900'>
							<div className='flex  items-center justify-center rounded-full'>
								<img
									src='/assets/illustration/Freedom.svg'
									className='h-36 w-36 rounded-full'
								/>
							</div>
							Freedom to Explore
						</dt>
						<dd className='mt-2 text-center max-w- leading-7 text-gray-600'>
							Follow your passion without a worry
						</dd>
					</div>
					<div className='relative '>
						<dt className='md:text-xl flex flex-col items-center justify-center itemtext-base font-semibold leading-7 text-gray-900'>
							<div className=' rounded-lg '>
								<img
									className='h-36 w-36 rounded-full'
									src='/assets/illustration/Savings.svg'
									alt=''
								/>
							</div>
							Affordability
						</dt>
						<dd className='mt-2 text-center md:px-12 leading-7 text-gray-600'>
							Renting seems much affordable
						</dd>
					</div>
					...
					<div className='relative '>
						<dt className='md:text-xl flex flex-col items-center justify-center itemtext-base font-semibold leading-7 text-gray-900'>
							<div className='flex  items-center justify-center rounded-lg '>
								<img
									className='h-36 w-36 rounded-full '
									src='/assets/illustration/Sustainability.svg'
									alt=''
								/>
						...
						<dd className='mt-2 text-center leading-7 text-gray-600 md:px-12'>
							Take care of planet by buying less
						</dd>
					</div>
				</dl>
			</div>
