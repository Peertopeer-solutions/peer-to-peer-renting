...
import DeleteIcon from '../../public/assets/svg/deleteIcon.svg?react';
import EditIcon from '../../public/assets/svg/editIcon.svg?react';
...
function ListingItem({ listing, id, onEdit, onDelete, onList, keyId, orders }) {
	...
	return (
		<div className='w-full md:w-[290px]' key={keyId}>
			<Link
				className='relative flex flex-col justify-start w-full md:w-[290px] h-full '
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
				...
				<img
					rel='preload'
					as='image'
					className='aspect-[4/3]	w-full sm:object-fit md:object-cover rounded-xl border border-gray-100 shadow-sm '
					src={listing.imgUrls[0]}
					alt={listing.title}
				/>
				<div className=' '>
					<div className=' my-3'>
						<p className='text-[16px] font-medium md:text-xl overflow-hidden line-clamp-2'>
							{listing.title}
						</p>
						...
						<div
							className={
								onList
									...
									: 'hidden  justify-between items-start py-3'
							}
						>
							{onList && (
								<div className='flex flex-col items-start '>
									...
									<p
										className={
											isEnabled
												? 'text-red-500 text-[15px] text-lg font-semiboldbold '
												: 'text-green-500'
										}
									>
							...
							<div className='space-y-1'>
								...
								{onEdit && (
									<EditIcon className=' ml-3' onClick={() => onEdit(id)} />
								)}
							</div>
						</div>
					</div>
