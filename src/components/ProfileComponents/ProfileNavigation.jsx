...
const ProfileNavigation = ({ toogle, setToogle }) => {
  ...
  return (
    <div>
      <div class="max-w-content no-scrollbar overflow-y-scroll h-[50vh] bg-gray-50  border-r rounded-lg p-6">
        {toogle && <button className=' container  mt-2 ' onClick={() => setToogle(false)}>
        ...
        <ul>
          <nav className='flex flex-col space-y-2'>
            ...
            <NavLink className={({ isActive }) => `p-1 ${isActive ? activeNavLink : nonActiveNavLink}`} to='requestedItems'>Your requests</NavLink>
