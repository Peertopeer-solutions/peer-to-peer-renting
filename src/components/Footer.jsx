...
import Drone from '../../public/assets/illustration/Drone.svg?react';
					...
					<div className='grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4'>
						<div>
							<nav className='flex flex-col mt-4 space-y-4 text-sm md:text-lg  text-gray-500'>
								<Link to='/termscondition' className='hover:opacity-75' href>
									{' '}
									Terms &amp; Conditions{' '}
								</Link>
								<Link to='shippingpolicy' className='hover:opacity-75' href>
									{' '}
									Shipping policy{' '}
								</Link>
								<Link to='/damagepolicy' className='hover:opacity-75' href>
									{' '}
									Damage policy{' '}
								</Link>
							</nav>
						...
						<div>
							<nav className='flex flex-col mt-4 space-y-2 text-sm md:text-lg    text-gray-500'>
								<Link to='privacypolicy' className='hover:opacity-75' href>
									{' '}
									Privacy Policy{' '}
								</Link>

								<Link to='/about-us' className='hover:opacity-75' href>
									{' '}
									About us
								</Link>
							</nav>
