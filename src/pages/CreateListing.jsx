        ...
        <div className=" w-full p-6 md:p-10 bg-white rounded-xl ">
          ...
          >
            <div className="grid grid-cols-1 space-y-2">
              ...
              <label htmlfor='images' className="text-sm font-bold text-gray-500 tracking-wide">
                Upload media
              </label>
              <div className="flex items-center justify-center w-full">

                <label htmlFor='images' className="flex flex-col rounded-lg border border-2px w-full items-center justify-center h-24  p-3 group text-center cursor-pointer">
            ...
            <div className="grid grid-cols-1 space-y-2">
              ...
              <input
                ...
                required
              />
              <label htmlFor='category' className="text-sm font-bold text-gray-500 tracking-wide">Category</label>

              <select className="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" name="dropdown" id="category" onChange={onMutate} >
            ...
            >
              ...
              <label className='text-sm font-bold text-gray-500 tracking-wide'>Regular Price</label>
              <div className='flex items-center '>
                <input
                  ...
                  required
                />
                {type === 'rent' && <p className=''>₹/<select name="dropdown" id="rentPeriod" onChange={onMutate} >
