...
const Listing = () => {
	...
	const {
		...
		isLoading,
		isError,
	} = useQuery(['listing', listingId], fetchListing);
	...
	return (
		<>
			...
			{isLoading ? (
				...
				<main>
					<div className='md:grid md:grid-cols-2 mx-auto md:gap-16 xl:gap-6 md:h-[100vh] overflow-y-scroll no-scrollbar '>
						<section className=' w-full md:max-h-full block'>
							<div className='relative w-full aspect-[4/3] flex items-center bg-gray-100  rounded-2xl '>
								...
								<img
									...
									src={
										displayImage === null ? listing.imgUrls[0] : displayImage
									}
									alt='img'
								/>
							</div>
							...
							<div className='hidden md:block'>{/* <ReviewList /> */}</div>
						</section>
						...
						>
							<div className={showRentalRequestForm
								...
								<PriceCard
									...
									listing={listing}
									setShowRentalRequestForm={setShowRentalRequestForm}
									showRentalRequestForm={showRentalRequestForm}
								/>
							...
							<div className='flex md:hidden flex-col space-y-2 leading-loose'>
								...
								<p className='text-[16px] font-normal text-gray-700 whitespace-pre-wrap'>
									{listing.description}
								</p>
							</div>
