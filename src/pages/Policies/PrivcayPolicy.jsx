...
const PrivcayPolicy = () => {
  return (
    <div className="container mx-auto md-5  ">
      {/* <header>
      ...
      <body>
        ...
        <Content>
          ...
          collected from users ("User" or "you") of the Rentivity web
          application ("Application"). This Privacy Policy applies to the
          Application and all products and services offered by Rentivity.
        </Content>
        ...
        <Content>
          ...
          Application, register on the Application, place an order, subscribe to
          the newsletter, respond to a survey, fill out a form, and in
          connection with other activities, services, features, or resources we
          make available on our Application. Users may be asked for their name,
          email address, mailing address, phone number, and other relevant
          information.
        </Content>

        <Content>
          We may also collect non-personal identification information about
          Users whenever they interact with our Application. Non-personal
          identification information may include the browser name, the type of
          computer or device used, technical information about Users' means of
          connection to our Application, such as the operating system and the
        ...
        <ul class="list-disc ml-6">
          <li>
            To provide and improve our services: Information you provide helps
            us deliver and enhance the functionality and features of our
            Application.
          </li>
          <li>
            ...
            and resources provided on our Application.
          </li>
          <li>
        ...
        <Content>
          ...
          business and the Application or administer activities on our behalf,
        ...
        <Content>
          ...
          to protect the security or integrity of our Application.
        </Content>

        <SubHeading>Changes to This Privacy Policy</SubHeading>

        <Content>
          Rentivity has the discretion to update this Privacy Policy at any
