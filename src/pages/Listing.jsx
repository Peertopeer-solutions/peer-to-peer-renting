        ...
        {requestStatus ? (
          ...
          <div className="  ">
            {showRentalRequestForm ? (
              ...
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" onClick={onClick}>Request Rental</button>
            )}
          </div>
        )}
      </section>
